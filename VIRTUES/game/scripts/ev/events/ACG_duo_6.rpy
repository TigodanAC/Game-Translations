label ACG_duo_6:
    ...
    g "But master hasn’t come yet, his dick is still so erect."
    ...
    c "Actually I don’t have anything good, either. You know, I was from a small family. We don’t really have any specific tradition."



    c "We have the bath together all the time, if that counts, but... ..."
    ...
    g "And master still hasn’t come. How remarkable~"



    c "I think it was because we both lasted for too short a time. Our bodies are getting more and more sensitive... by being trained by his cock every day."
