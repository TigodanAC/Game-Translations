label ACG_duo_9:
    ...
    a "You are not satisfied with [P]’s performance on the bed?"
    ...
    c "I mean, we have done no birth control creampie so many times, but none of us is pregnant yet."
    ...
    g "Was it because you have a little sister who always acts like a kid?"
    ...
    a "This is... not in the family tradition... ..."
    ...
    c "Well, on second thought~ I’m not really in that rush to become a mother anyway~"
