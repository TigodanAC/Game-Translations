label d7_1:
    ...
    narrator "But now things have become weird. I mean, both of us have grown up. It is inappropriate for us to sleep together anymore."
    ...
    d "You don't like staying with me?"
    ...
    narrator "Well, no matter how she denies it, her increasing breast size has proved everything. Although her tits are not as marvelous as her sister yet, I am very optimistic about her potential."
    ...
    player "(Now let's just take this as a test of my endurance...)"
    ...
    narrator "My penis is getting harder every second... ... It's not my fault. Every healthy man would have an erection in my situation."
    ...
    player "*Being awkward* Ha... No, I can... I can explain..."
    ...
    player "Eh, well, about that... That's just a regular physiological change called “Morning Wood.” Haven't you heard of it at your physiology class?"
    ...
    narrator "She got up from the bed huffily and then stormed out of my room."
    ...
    narrator "Suddenly, I heard someone opening the door."
    ...
    player "I guess I said something wrong..."
    ...
    c "I texted you last night, didn't you receive it?"

    player "*Being awkward* Oh..."

    narrator "I didn’t get her text because I had already put her number on my blacklist since the last time we had a quarrel."
    ...
    c "It doesn't matter. I just removed your number from my blacklist yesterday to text you~"

    player "Oh, ha..."

    c "Anyway, hurry up. You don't want to keep my mom waiting."
