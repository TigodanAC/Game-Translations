label ACG_duo_2:
    ...
    "Ever since Theo moved in, I’ve been avoiding to staying with all the girls in the house together."
    ...
    "It seems like I am not the only one who feels awkward here. Ah, shit, things are getting more awkward every second if we all keep silent."
    ...
    c "Let’s go to shower together, so that we can... share some girls secrets and build our friendships while being completely candid to each other~"
    ...
    g "Nope~ I am the one that [P] loves the most~ I am [P]’s precious titty slave~"
    ...
    player "Theo has no doubt the largest and heaviest boobs among you three."
    ...
    player "Her nipples... they are extremely sensitive. Theo will obey whatever I say when I have them in my hands~"
    ...
    a "I... I can’t be the only one left. I want to be a titty slave too~"
