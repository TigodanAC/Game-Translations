label C_daily_7:
    ...
    player "(Just... keep doing these repetitive works every day.)"
    ...
    "Colleague B" "Save it. I heard he is Manager Shinyrost’s fiance. He can do whatever he wants in this company."
    ...
    "Colleague A" "No, more than 1 hour! He's been sleeping for more than 1 hour!"
    ...
    c "The air conditioner is on. He may get cold if sleeping like this."
